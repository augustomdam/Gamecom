                ...
                <nav class="navbar navbar-fixed-top" role="navigation">
                    ...
                    <div class="navbar-nav  mr-n2 ml-auto">
                        ...
                        <ul class="nav navbar-custom-menu">
                            ...
                            <li class="nav-item mr-5">
                                    <a class="nav-link" href="{{ route('home.public') }}">
                                        Home
                                    </a>
                                </li>
                            <li class="nav-item mr-4">
                                <a class="nav-link" href="{{route('user.profile', Auth::user()->id)}}">
                                    <img src="{{ url("http://gamecomstorage.s3-sa-east-1.amazonaws.com/". Auth::user()->imagem)}}" class="img-circle"
                            ...
                            <li class="nav-item">
                                ...
                                version_compare(\Illuminate\Foundation\Application::VERSION, '5.3.0', '<')) <a
                                    class="nav-link" href="{{ url(config('adminlte.logout_url', 'auth/logout')) }}">
